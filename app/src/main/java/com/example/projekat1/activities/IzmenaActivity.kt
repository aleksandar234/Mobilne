...
class IzmenaActivity : AppCompatActivity(R.layout.activity_izmena) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnIzmeni.setOnClickListener {
            ...
            user = User(ime,prezime,bolnica)
            val intent1 = Intent(this,MainScreenActivity::class.java)
            intent1.putExtra("Profil","Activity4")
            intent1.putExtra(Konstants.USER,user)
